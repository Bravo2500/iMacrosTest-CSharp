...
namespace iMacrosPostingDashboard
{
    class FamiljeLivSE
    {
        ...
        public static DateTime StartTime = Convert.ToDateTime("09:05:00 AM");
        ...
        public static void PostNextTopic(Object sender, DoWorkEventArgs e)
        {
            ...
            Topicsfamiljeliv tbltopics = new Topicsfamiljeliv();
            string ProjectName = "FamiljeLivSE";
                ...
                else  // If not STOPed, then continue with the next keyword
                {
                    ...
                    else
                    {
                        ...
                        if (stdfunc.CreateAccount(tblaccts.Username, tblaccts.Email, tblaccts.Password, tblaccts.FirstName, tblproxies.Proxy, proj.ImacrosCreateAccCode))
                        {
                            ...
                            string PassExtracted = HotmailPOP.ExtractConfLink(tblaccts.Email, tblaccts.Password, proj.Linkstructure, proj.Senderemail, proj.ShiftLinkstructureBy);
                                ...
                                
                            {
                                ...
                                worker.ReportProgress((2 * 4 * 10), "Account confirmed. Shortening URLs...");
                                ...
                                */
                                ...
                                tblresp.Where.ResponseGroup.Value = "TraderaSE-one-link";
                                ...
                                worker.ReportProgress((2 * 4 * 10), "Now posting...");

                                if (tbltopics.ShortURL1 != "" && tbltopics.ShortURL1 != null)
                                {

                                    if (stdfunc.LoginAndPost(tblaccts.Username, tblaccts.Email, PassExtracted, tblproxies.Proxy, tbltopics.Link, GeneragedResponse, proj.ImacrosLoginPost))
                                    {
                                        //
